...
import timeit
from .generalized_vl_rcnn import build_generalized_vlrcnn_model
...
class GLIPDemo(object):
    def __init__(self,
        ...
        self.model = build_generalized_vlrcnn_model(cfg)
        self.model.eval()
    ...
    def inference_on_image(self, original_image, original_caption):
        predictions = self.compute_prediction(original_image, original_caption)
        top_predictions = self._post_process_fixed_thresh(predictions)
